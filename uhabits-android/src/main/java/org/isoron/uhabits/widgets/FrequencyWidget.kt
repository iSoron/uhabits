...
class FrequencyWidget private constructor(
    ...
    constructor(context: Context, widgetId: Int, habit: Habit, firstWeekday: DayOfWeek, stacked: Boolean = false) : this(context, widgetId, habit, null, firstWeekday, stacked)
    constructor(context: Context, widgetId: Int, habitGroup: HabitGroup, firstWeekday: DayOfWeek, stacked: Boolean = false) : this(context, widgetId, null, habitGroup, firstWeekday, stacked)
